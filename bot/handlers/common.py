...
HELP_TEXT = (
    ...
    "<b>Команды:</b>\n"
    "/quiz — следующий вопрос (тренировка)\n"
    "/stats — прогресс по темам\n"
    "/subscribe — включить «вопрос дня»\n"
    "/unsubscribe — выключить «вопрос дня»\n"
    "/help — эта справка\n\n"
    "В тренировке: читаешь вопрос → жмёшь «Показать ответ» → честно "
    "оцениваешь себя. Чем хуже знал — тем раньше вопрос вернётся."
)
