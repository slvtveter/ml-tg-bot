...
SYSTEM = (
    ...
    "воды. Технические термины оставляй в оригинале (английском). В разборе можешь "
    "выделять ключевое **жирным** и писать код/формулы в `обратных кавычках`."
)
...
TUTOR_SYSTEM = (
    ...
    "Оформляй ответ в markdown: **выделяй** ключевые термины жирным, списки через "
    "'- ', код и формулы в `обратных кавычках`. Без таблиц и заголовков (#)."
)
